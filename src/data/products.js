export const products = [
  ...
  },
  {
    ...
    description: 'Professional video editing tools with AI-powered effects and transitions.',
    price: 59,
    period: 'monthly',
    tag: 'New',
    tagType: 'new',
    features: ['4K export', 'AI auto-cut', '500+ effects'],
    icon: '🎬',
  },
  {
    id: 8,
    name: 'SEO Optimizer Tool',
    description: 'Boost your search rankings with data-driven SEO recommendations and tracking.',
    price: 35,
    period: 'monthly',
    tag: 'Popular',
    tagType: 'popular',
    features: ['Keyword tracking', 'Competitor analysis', 'Weekly reports'],
    icon: '📈',
  },
]
